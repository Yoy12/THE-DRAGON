...
namespace DRAGONLake
{
	public static partial class Functions
	{
		...
		public static void ResetVariables()
		{
			...
			ATK = 5; 
			GOLD = 500; 
			bountyNeed = 5/*how many bounties to next level*/;

			newDeathCounter = 30;
			area = level = bountyLevel = 1/*1 = easyOnly, 2 = medium & easy, 3 hard, medium, & easy, 4 = miniBosses and all others*/;
			WILL = re = regular = 0;
			bountyCollected = bountiesCleared = bountyCost = EXP = 0;

			noCabin = stop = dodge = stop2 = inventoryFull = quickEnd = hasBounty = stop3 = hasStarted = goAnyway = false;
			debug = stupidBool = newgame = true;
			//static Object[] Mark = new Object[] {45/*hp, 0*/, 25/*speed, 1*/, 23/*attack, 2*/, "Mark Conjure"/*name, 3*/};

			inventory = new string[] { "potion", "potion", "potion", "null", "null", "null", "null", "null", "null", "null", "null"/*not used until endgame*/};
			go1 = new string[] { "springs", "hills", "forests", "debug" };
			storage = new string[] { "null", "null", "null", "null", "null", "null", "null", "null", "null", "null", "null", "null", "null", "null", "null", "null", "null", "null", "null", "null" };
			
			bountyCostings = new float[] { 0, 0, 0 };//How much the bounties cost

			Bounty1 = Bounty2 = Bounty3 = new int[] { 0/*1 = easy, 2 = medium, 3 = hard*/, 0, 0, 0/* if one, also miniboss*/};
			
			firstTime = new bool[] { true/*SPECIAL*/, true/*attacking, grabbing, running*/, true/*options*/, true/*enter*/, true/*shopping*/, true/*bounty board*/, true/*apartments*/, true/*hunt zone*/};
			From = new bool[] { false/*springs 2*/, false/*hills*/, false/*forest Mountains*/, false/*forest hills*/, false/*springs 1*/};
			ending = new bool[] { false/*first*/, false/*second, final*/};
			bounties = new bool[] { false/*easyEnemy*/, false/*easyEnemy*/, false/*easyEnemy*/, false/*medium enemy*/, false/*medium enemy*/, false/*medium enemy*/, false/*hard enemy*/, false/*hard enemy*/, false/*hard enemy*/, false/*miniboss enemy*/} /*the current bounty*/;
			storyEventFM = new bool[] { true/*Dinner*/, true, true, true, true, true };
			playedWith = new bool[] { true, false, false, false };

			Mark = new Fighter() { HEARTS = 50, HP = 50, ATK = 23, SPE = 25, name = "Mark Conjure", EXP = 0, EXPNeed = 2000 };
			Breys = new Fighter() { HEARTS = 80, HP = 80, ATK = 40, SPE = 90, name = "Breys Swolder", EXP = 0, EXPNeed = 10000 };
			Sapphire = new Fighter() { HEARTS = 100, HP = 100, ATK = 45, SPE = 70, name = "Sapphire Jewls", EXP = 0, EXPNeed = 9000 }; 
			Captain = new Fighter() { HEARTS = 250, HP = 250, ATK = 50, SPE = 50, name = "Captain" };
			enemy = new Fighter() { HP = 40, ATK = 15, SPE = 35 };

			Random rando = new Random();
			Random monRand = new Random();

			//Teammate variables
			fMark_1 = Mark.HEARTS;//fMark_1
			teamMateHP = Mark.HP;//fMark0
			teamMateSPE = Mark.SPE;//fMark1
			teamMateATK = Mark.ATK;//fMark2
			teamMateName = Mark.name;//fMark3
			teamMateLevel = Mark.level;//fMark4
			teamMateEXP = Mark.EXP;//fMark5
			teamMateEXPNeed = Mark.EXPNeed;//fMark6
			teamMater = 0;
		...
		public static void Save(bool onlyCreate = false)
		{
    	...
    	public static void Space(int spaces = 1) 
		{
			...
			for(int i = 0; i < spaces; i++) Console.WriteLine();
    	}
		...
		public static void Enter()
		{
			...
			if(firstTime[3])
			{
				Writer("Press ENTER (or RETURN) to continue. Also do so when you see '>', or press 'U' to use an item.");
				Writer("Press Enter (or RETURN) Here: ", 2);
				firstTime[3] = false;
			}
			else
				Writer("> ", 2);
    	...
    	public static void MonsterEncounter(float hp = 10,
                                         float speed = 3,
                                         float attack = 2,
                                         ...
                                         float speedTwo = 10,
                                         float attackTwo = 1,
                                         string monNameTwo = "Monster 2",
                                         int teamMate = 0,
                                         string status = "Fine",
                                         string powerAttack = "Super Hit",
                                         float powerAttackHit = 10,
                                         float powerAttackHeal = 2,
                                         bool isHealing = false,
                                         bool isDefending = false,
                                         int waitTime = 1,
                                         string statusAfflict = "null",
                                         bool hasWeight = true,
                                         bool hasPattern = false,
                                         string statusTwo = "Fine",
                                         string powerAttackTwo = "Super Hit",
                                         float powerAttackHitTwo = 10,
                                         float powerAttackHealTwo = 2,
                                         bool isHealingTwo = false,
                                         bool isDefendingTwo = false,
                                         int waitTimeTwo = 0,
                                         string statusAfflictTwo = "null",
                                         bool hasWeightTwo = true,
                                         bool hasPatternTwo = false,
                                         int[] patternTwo = null,
                                         int[] weight = null,
                                         int[] pattern = null,
                                         int[] weightTwo = null,
                                         ...
                                         bool canRun = true)
		{
			...
			{		
				...
				for(int t = 0; t < turnOrder.Length; t++) 
				{
					...
					else if(turnOrder[t] == teamMateSPE && doubleBattle) 
					{
					...
					else if(turnOrder[t] == speedTwo && twoEnemy)
					{
						//mon1 death check
						if(hpTwo <= 0)
						{
