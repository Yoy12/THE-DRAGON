...
namespace DRAGONLake
{
	public static partial class Functions
	{
		...
		//Springs
		public static Monster n000 = new Monster() {hp = 20,
			speed = 3,
			attack = 4,
			monName = "Mossatle",
			exp = 900F,
		...
		public static Monster n009 = new Monster() {
			...
			message = " readies for battle, smiling with excitement!"
		};
		...
		public static Monster n010 = new Monster() {
			...
			message = " sings sea shanties into battle!"
		};
		...
		public static Monster n011 = new Monster() {
			...
			message = " stands anime-like as Crossing Field plays in the background. Could you kill this guy already?"
        };
